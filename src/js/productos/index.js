...
const buscar = async () => {
    ...
    const url = `/login_prueba/API/productos/buscar?producto_nombre=${producto_nombre}&producto_precio=${producto_precio}`;
...
const guardar = async (evento) => {
    ...
    const url = '/login_prueba/API/productos/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/login_prueba/API/productos/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if (await confirmacion('warning', 'Desea elminar este registro?')) {
        ...
        body.append('producto_id', id)
        const url = '/login_prueba/API/productos/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method: 'POST',
